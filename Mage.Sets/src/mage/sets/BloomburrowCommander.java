...
public final class BloomburrowCommander extends ExpansionSet {
    ...
    private BloomburrowCommander() {
        ...
        cards.add(new SetCardInfo("Zinnia, Valley's Voice", 4, Rarity.MYTHIC, mage.cards.z.ZinniaValleysVoice.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Zinnia, Valley's Voice", 104, Rarity.MYTHIC, mage.cards.z.ZinniaValleysVoice.class, NON_FULL_USE_VARIOUS));
